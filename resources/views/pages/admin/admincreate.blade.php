...
@section('content')
    ...
    <div class="pagetitle">
        <h1>Creer un nouveau administrateur</h1>
        <nav>
            <ol class="breadcrumb">
        ...
        <div class="card-body">
            ...
            <form method="post" class="row d-flex justify-content-center needs-validation" id="classe-form">
                                        ...
                                        <div class="row mb-3">
                                                ...
                                                <div class="col-sm-10">
                                                    <input :value="old('email')" required autofocus name="adminemail" type="email" class="form-control" placeholder="Email du compte">
                                                </div>
                                            </div>
                                            <div class="row mb-3">
                                                <label for="code">Nom: <span class="text-danger ql-size-huge">*</span></label>
                                                <div class="col-sm-10">
                                                    <input :value="old('nom')" required autofocus name="adminnom" type="text" class="form-control" placeholder="Nom du compte">
                                                </div>
                                            </div>
                                            <div class="row mb-3">
                                                <label for="code">Mot de passe: <span class="text-danger ql-size-huge">*</span></label>
                                                <div class="col-sm-10">
                                                    <input required minlength="3" maxlength="60" id="intitule" name="adminpassword" type="password" class="form-control" placeholder="Mot de passe">
                                                </div>
                                            </div>
